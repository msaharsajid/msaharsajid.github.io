...
-   **Camp Two:** Aid always causes corruption; regime type has no impact
    ...
    -   *Bader et al., 201* ← (Is this missing a digit?)
...
![](figures/figureB.png) sources: V-Dem: Regime Type, CRS: Total ODA disbursements over time
...
![](figures/figureC.png) sources: V-Dem: Regime Type, CRS: aid sectors
